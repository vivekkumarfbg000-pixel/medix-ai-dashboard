...
const LabAnalyzer = () => {
    ...
    const handleShare = () => {
        ...
        // Construct real WhatsApp message
        const message = `*🏥 MediFlow AI Report Summary*\n\n` +
            `*Summary:* ${report.summary}\n\n` +
            `*🚨 Possibility:* ${report.diseasePossibility.join(", ")}\n\n` +
            `*🥗 Recommended Diet:* ${report.recommendations.diet.join(", ")}\n\n` +
            `*👨‍⚕️ Next Steps:* ${report.recommendations.nextSteps.join(", ")}\n\n` +
            `_Generated by PharmaAssist.AI_`;

        const encodedMessage = encodeURIComponent(message);
        const url = patientPhone
            ? `https://wa.me/91${patientPhone}?text=${encodedMessage}`
