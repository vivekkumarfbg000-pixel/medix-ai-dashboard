/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c88e3a657975540a2a81c735fc964c30)
// Runtime types generated with workerd@1.20260312.1 2024-04-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_SUPABASE_PROXY_URL: string;
		VITE_N8N_WEBHOOK_URL: string;
		VITE_N8N_OPS_URL: string;
		GROQ_API_KEY: string;
