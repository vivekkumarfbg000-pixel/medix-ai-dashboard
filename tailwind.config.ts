  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'medical': '0 4px 20px -4px hsl(210 100% 35% / 0.12)',
        'glow': '0 0 30px hsl(210 100% 35% / 0.3)',
        'glow-success': '0 0 30px hsl(142 71% 45% / 0.3)',
        'glow-danger': '0 0 30px hsl(0 84% 60% / 0.3)',
      },
      backdropBlur: {
        xs: '2px',
      },
      keyframes: {
        ...
        "pulse-recording": {
          ...
          "50%": { boxShadow: "0 0 0 12px hsl(0 84% 60% / 0)" },
        },
        "float": {
